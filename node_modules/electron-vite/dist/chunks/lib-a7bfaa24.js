...
const _require$1 = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('chunks/lib-a7bfaa24.js', document.baseURI).href)));
...
function startElectron(root) {
    ...
    const ps = node_child_process.spawn(electronPath, ['.'].concat(args), { stdio: 'inherit' });
...
const _require = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('chunks/lib-a7bfaa24.js', document.baseURI).href)));
